...
namespace t9n.api.jsonConverter
{
    public class ArbResourceCollectionJsonConverter : JsonConverter<ArbResourceCollection>
    {
        ...
        public override void Write(Utf8JsonWriter writer, ArbResourceCollection value, JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteString( "@@locale", value.Locale );
            }
            ...
            foreach ( var ae in value.ArbEntries )
            {
                ...
                if ( ae.Type != null || ae.Context != null || ae.Description != null || ae.Screen != null || ae.Source_text != null )
                {
                    ...
                    if ( ae.Type != null )
                    {
                        writer.WriteString( ae.Type.AttributeName, ae.Type.AttributeValue );
                    }

                    if ( ae.Context != null )
                    {
                        writer.WriteString( ae.Context.AttributeName, ae.Context.AttributeValue );
                    }

                    if ( ae.Description != null )
                    {
                        writer.WriteString( ae.Description.AttributeName, ae.Description.AttributeValue );
                    }

                    if ( ae.Screen != null )
                    {
                        writer.WriteString( ae.Screen.AttributeName, ae.Screen.AttributeValue );
                    }

                    if ( ae.Source_text != null )
                    {
                        writer.WriteString( ae.Source_text.AttributeName, ae.Source_text.AttributeValue );
                    }
